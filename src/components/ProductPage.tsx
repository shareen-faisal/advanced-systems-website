  ...
  >
    {icon === "intelligent" && (
      <path
        ...
        d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M12 5.25v.01M16.5 8.25v.01M12 12v.01M12 16.5v.01M4.875 12a7.125 7.125 0 0114.25 0H4.875z"
      />
    )}
    {icon === "timer" && (
      <path
    ...
    {icon === "durable" && (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.73-.626 1.196-.626h.178c.47 0 .897.242 1.196.626l2.496 3.03M11.42 15.17L9.36 12.417c-.364-.464-.903-.742-1.484-.742a2.08 2.08 0 00-1.484.742L3 21m0 0h18"
      />
    )}
    {icon === "mobile" && (
      <path
          ...
          <div className={styles.imageGallery}>
            <div className={styles.mainImage}>
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src = `https://placehold.co/600x600/e2e8f0/334155?text=Image+Not+Found`;
                }}
              />
            </div>
              ...
              {images.map((img, idx) => (
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src = `https://placehold.co/150x150/e2e8f0/334155?text=Error`;
                    }}
                  />
                </div>
              ))}
